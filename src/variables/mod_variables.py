...
v_plan_code_best_new= 'PLAN_CODE_BEST'
v_weeks_general = 'WEEKS_EVENT_GENERAL'
v_session_best_number = 'SESSIONES'
v_session_repetion = 'REPETICION'
v_weeks_duration = 'DURACION_SEMANAS'
v_hours_duration_best = 'HORAS'
v_rule_weeks = 'REGLA'

v_hourSlotBegin = 'SLOT_BEGIN'
v_hourSlotEnd = 'SLOT_END'

v_student_number_uxxi = 'ALUMNOS/CAPACIDAD'
...
v_student_group =	'ID_GRUPO'
v_student_group_name = 'GRUPO_NAME'
v_activity_code =	'CODIGO_ACTIVIDAD'
v_activity_id = 'ID_ACTIVIDAD'
...
v_control_comun_mod = 'CONTROL_COMPARTIDA'
v_control_comun_mod_id = 'CONTROL_COMPARTIDA_ID'
v_teacher_name = 'PROF_NAME'
v_teacher_code = 'PROF_COD'
v_id_teacher = 'ID_PROF'
v_center = 'CENTRO'
v_student_group_temp_BI = 'ID_GROUP_TEMP' # BI RELATIVO A GRUPOS DE INGLES

v_student_group_name = 'GRUPO'
v_student_group_best = 'GRUPOS_BEST'
v_student_group_best_temp = 'GRUPO_BEST_TEMP'
v_student_group_id_best = 'ID_GRUPO_BEST'
v_student_group_name_practic_plan = 'NameGroupPracticPlan'
v_number_st_group_practic_plan = 'NumberPracticPlan'
v_number_st_group_practic_module = 'NumberPracticModule'
...
v_annotation_event = 'ANNOTATION_EVENT'
...
v_category_id_dto = 'categoryIdentifier'
v_labour_contract_dto = 'labourContractIdentifier'
v_const_free_days_dto = 'constFreeDays'
v_free_days_dto = 'freeDays'
...
v_teacher_contract = 'Contract'
v_teacher_category = 'Category'
...
v_categories_controller = 'Categories'
v_contract_controller = 'LabourContracts'
